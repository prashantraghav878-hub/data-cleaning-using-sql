...
-- one solution, which I think is a good . Is to create a new column and add those row numbers in. Then delete where row numbers are over 2, then delete that column
...
-- makes it easy so if there were thousands I don't have to manually check them all
